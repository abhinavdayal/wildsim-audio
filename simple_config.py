...
class SceneConfig:
    ...
    def from_dict(cls, data: dict) -> "SceneConfig":
        """Create SceneConfig from dictionary data"""
        sounds = [
            SoundPlacement(
                audio_file=s["audio_file"],
                ...
                # These fields are auto-calculated in __post_init__ but we can provide them
...
class SceneBuilder:
    ...
    def create_simple_scene(self, name: str, duration: float = 10.0) -> SceneConfig:
        ...
        return SceneConfig(
            ...
            duration=duration,
            sounds=[],
            ambient=[AmbientSound("forest", -45.0)],  # Basic forest background
